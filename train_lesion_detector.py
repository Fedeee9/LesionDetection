...
def train(model, labelsTrain, labelsVal, train_images, val_images):
    ...
    # callbacks
    save_model_callback = ModelCheckpoint(config.model_checkpoint, monitor='val_accuracy', save_best_only=True,
    ...
    reduce_lr_callback = ReduceLROnPlateau(monitor='val_accuracy', mode='auto', factor=0.5, patience=5, min_lr=0.000001,
                                           verbose=1)
